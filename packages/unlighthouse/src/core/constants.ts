    ...
    'performance': [
        ...
        },
        {
            cols: {
                xs: 0,
                xl: 1,
            }, label: 'TTI', tooltip: 'Time To Interactive', sortKey: 'numericValue', key: 'report.audits.interactive'
        },
        {
            cols: {
                xl: 2,
                xs: 0
            }, label: 'Network Requests', sortKey: 'length:details.items', key: 'report.audits.network-requests'
        },
    ...
    'seo': [
        ...
        },
        {
            cols: {
                ...
                lg: 3,
                xl: 2,
            }, label: 'Description', key: 'seo.description'
        },
        {
            cols: {
                xs: 3,
                xl: 2,
            }, label: 'Share Image', key: 'seo.og.image'
        },
    ],
    'pwa': [
