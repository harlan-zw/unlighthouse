// @unlighthouse/core/packs/nuxt
//
// A Nuxt-aware pack, and the reference implementation for authoring a
// third-party Unlighthouse pack. Its implementation depends only on
// `@unlighthouse/contracts` and Zod — a pack is a reconciler + a report schema,
// not a fork of core.
//
