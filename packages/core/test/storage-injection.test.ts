...
import { buildIndexedDbInjectionScript, buildStorageInjectionScript } from '../src/auditors/storage-injection'
...
describe('buildIndexedDbInjectionScript', () => {
  ...
  it('produces a self-contained, syntactically valid IIFE', () => {
    ...
    // eslint-disable-next-line no-new-func -- the generated trusted fixture is compiled only to validate syntax.
