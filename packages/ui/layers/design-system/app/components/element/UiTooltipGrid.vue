...
useEventListener(window, 'scroll', onScrollOrResize, { passive: true, capture: true })
useEventListener(window, 'resize', onScrollOrResize, { passive: true })
</script>
        ...
        >
          ...
          <div class="flex-1 min-w-0 pl-2.5">
            ...
            <div v-if="data.title" class="flex items-center gap-1.5 mb-1.5">
              ...
              <span class="text-label text-dimmed">
                {{ data.title }}
              </span>
            </div>
            <template v-if="data.details?.length">
              ...
              <div class="flex items-baseline gap-1.5 mb-0.5">
                ...
                <span class="text-label text-dimmed">{{ data.details[0]!.label }}</span>
              </div>
