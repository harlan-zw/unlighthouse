          ...
          <template v-if="presetFilters.length">
            ...
            <div role="group" aria-label="Preset filters">
              <button
                ...
                class="cursor-pointer w-full flex items-center gap-2 px-3 py-2.5 sm:py-1 text-xs transition-colors outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-inset relative"
