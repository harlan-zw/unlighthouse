export default {
  ...
  ui: {
    ...
    icons: {
      ...
      chevronDoubleLeft: 'i-carbon-page-first',
      chevronDoubleRight: 'i-carbon-page-last',
      ...
      loading: 'i-svg-spinners-bars-rotate-fade',
    ...
    // PageHeader - Documentation page headers
    pageHeader: {
      slots: {
        root: '',
        container: '',
