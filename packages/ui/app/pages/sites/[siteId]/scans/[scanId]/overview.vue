    ...
    <div class="flex items-center justify-between">
      <div>
        ...
        <div class="flex items-center gap-2 mt-1.5 text-sm text-muted">
          ...
          <UBadge v-if="hasMultipleDevices" variant="outline" class="text-xs">
            <Icon name="lucide:smartphone" class="size-2.5 mr-0.5" />
            <Icon name="lucide:monitor" class="size-2.5 mr-0.5" />
            both
          </UBadge>
          <UBadge v-else-if="scanMeta?.device" variant="outline" class="text-xs">
      ...
      <div class="flex items-center gap-2">
        ...
        <UButton v-if="scanIsComplete && !currentScanIsActive" color="neutral" variant="outline" size="sm" :disabled="rescanningAll" @click="handleRescanAll">
