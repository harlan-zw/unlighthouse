...
<template>
<btn-action v-if="value" @click="openModal" title="Open full image" class="w-full">
  ...
  <teleport v-if="isModalOpen && showingModal" to="#modal-portal">
    <h2 class="font-bold text-lg mb-1 text-gray-700 dark:text-gray-300">Screenshot Thumbnails</h2>
    <p class="mb-5 text-gray-600 dark:text-gray-400">This is what the load of your site looked like, 300ms apart.</p>
