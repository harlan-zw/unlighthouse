...
const aliasEntries = [
  ...
  ['@unlighthouse/contracts/client', './packages/contracts/src/client/index.ts'],
  ...
  ['@unlighthouse/core/runtime', './packages/core/src/runtime.ts'],
  ...
  ['@unlighthouse/core/seeds/sitemap-parser', './packages/core/src/seeds/sitemap-parser.ts'],
  ...
  ['@unlighthouse/core/crawlers/parallel-map', './packages/core/src/crawlers/parallel-map/index.ts'],
  ...
  ['@unlighthouse/core/packs/nuxt', './packages/core/src/packs/nuxt.ts'],
  ['@unlighthouse/cloudflare', './packages/cloudflare/src/index.ts'],
  ['@unlighthouse/cloudflare/auditors/container', './packages/cloudflare/src/auditors/container.ts'],
  ['@unlighthouse/cloudflare/durable-objects', './packages/cloudflare/src/do/index.ts'],
  ['@unlighthouse/cloudflare/events', './packages/cloudflare/src/scan-events-emit.ts'],
  ['@unlighthouse/cloudflare/seeds', './packages/cloudflare/src/seeds/index.ts'],
  ['@unlighthouse/cloudflare/storage', './packages/cloudflare/src/storage/d1-r2.ts'],
  ['@unlighthouse/cloudflare/workflows/scan', './packages/cloudflare/src/workflows/scan.ts'],
  ['@unlighthouse/lighthouse-container/server', './packages/lighthouse-container/src/server.ts'],
