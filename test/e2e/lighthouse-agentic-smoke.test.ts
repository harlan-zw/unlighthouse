  ...
  <body>
    ...
    try {
      const [{ launch }, lighthouseModule] = await Promise.all([
        import('../../node_modules/.pnpm/chrome-launcher@1.2.1/node_modules/chrome-launcher/dist/index.js'),
        import('../../node_modules/.pnpm/lighthouse@13.4.0/node_modules/lighthouse/core/index.js'),
      ])
      chrome = await launch({
