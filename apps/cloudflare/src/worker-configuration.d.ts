/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc src/worker-configuration.d.ts` (hash: f8272294ef55600f4ca214fc2e687584)
...
interface __BaseEnv_Env {
	...
	UNLIGHTHOUSE_ALLOWED_ORIGINS: "https://example.com";
	UNLIGHTHOUSE_CONFIG: "{\"site\":\"https://example.com\",\"retention\":{\"maxScansPerSite\":30,\"maxAgeDays\":90,\"keepCiBaselines\":true}}";
	RATE_LIMITER_CAPACITY: "2";
	RATE_LIMITER_REFILL_PER_SEC: "0.0166667";
	UNLIGHTHOUSE_API_TOKEN: string;
	SHARED_AUDIT_TOKEN: string;
	CF_BROWSER_RUN_TOKEN: string;
	RATE_LIMITER_DO: DurableObjectNamespace<import("./worker").RateLimiterDO>;
	LIGHTHOUSE_CONTAINER: DurableObjectNamespace<import("./worker").LighthouseContainer>;
	AUDIT: Service<typeof import("./worker").AuditEntrypoint>;
	SCAN_WORKFLOW: Workflow<Parameters<import("./worker").ScanWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker");
		durableNamespaces: "RateLimiterDO" | "LighthouseContainer";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "CF_ACCOUNT_ID" | "UNLIGHTHOUSE_ALLOWED_ORIGINS" | "UNLIGHTHOUSE_CONFIG" | "RATE_LIMITER_CAPACITY" | "RATE_LIMITER_REFILL_PER_SEC" | "UNLIGHTHOUSE_API_TOKEN" | "SHARED_AUDIT_TOKEN" | "CF_BROWSER_RUN_TOKEN">> {}
}
