...
import type { CloudflareEnv, CreateCloudflareAppOptions } from '../src/runtime'
...
import { createCloudflareApp } from '../src/runtime'

// Minimal Workers-runtime shim; the upstream interface includes platform-only
// members that this request-policy test never exercises.
